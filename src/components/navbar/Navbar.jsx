...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg fixed-top bg-light mb-2">
      <nav
        className={`navbar hidden navbar-expand-lg fixed-top bg-light mb-2 ${
          isOpen ? "w-75 rounded-bottom contnav" : ""
        }  `}
      >
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          >
            ...
            <div className="d-flex flex-column gap-3 align-md-items-center flex-md-row ml-1">
              {currentUser && (
